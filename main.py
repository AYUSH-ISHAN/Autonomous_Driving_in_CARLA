...
def main():
    ...
    if args.scenario=="road_distubance":
        net_structure = 4
    elif args.scenario=="two_car_collision":
        net_structure = 3
    elif args.scenario=="multi_car_collision":
        net_structure = 2
    elif args.scenario=="cruise_control":
        net_structure = 1
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        branch_losses, speed_losses, losses = \
            train(train_loader, model, criterion, optimizer, epoch, tsbd, net_structure)
...
def train(loader, model, criterion, optimizer, epoch, writer, net_structure):
